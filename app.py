...
if st.sidebar.button("🚀 GENERAR PLANEACIÓN COMPLETA"):
    if not api_key:
        ...
        try:
            ...
            model = genai.GenerativeModel('gemini-3.1-flash-preview') # He puesto flash para asegurar compatibilidad, pero si prefieres el 3.1 cámbialo a 'gemini-3.1-flash-preview'
